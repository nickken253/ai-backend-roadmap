...
const { registerUser, loginUser, getUserProfile, updateUserProfile, changePassword, verifyEmail, forgotPassword, resetPassword,sendVerificationEmail } = require('../controllers/authController');
